...
scenarios=(closed sessionList claudeDemo approvalCard questionCard completionCard longCompletionCard spotifyPlayer tasksList calendarAgenda calendarConnect calendarEmpty calendarDenied)
